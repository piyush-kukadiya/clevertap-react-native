 ...
 */
    ...
    */
     ...
     * Throttled to once every 5 minutes. Pass an optional callback to receive a success/failure boolean.
     * @param {function(err, res)} optional callback receiving (error, success: boolean)
     */
     ...
     * @param {object} additionalProperties - key-value pairs including wzrk_element_id and any tracking fields
     */
